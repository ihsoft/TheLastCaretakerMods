...
class VOYAGE_API UVoyageDynamicPlayerInputWidget : public UUserWidget
{
    GENERATED_BODY()

public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite)
    bool bRegisterFromWidgetOwner = false;

    UPROPERTY(BlueprintReadWrite)
    TObjectPtr<UPanelWidget> ContextInputActionsRoot = nullptr;
};
