...
class UVoyageButtonInfoContainerWidget;

UCLASS(BlueprintType)
class VOYAGE_API UInteractIndicator : public UUserWidget
{
    GENERATED_BODY()

public:
    UPROPERTY(BlueprintReadWrite)
    TObjectPtr<UVoyageButtonInfoContainerWidget> ButtonInfoContainer = nullptr;
};
