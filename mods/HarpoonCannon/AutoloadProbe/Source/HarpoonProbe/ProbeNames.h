...
inline constexpr TCHAR MarkerText[] = TEXT("HC03 DRONE BELOW - USE STOCK ENTER");
...
inline constexpr TCHAR WaitingText[] = TEXT("HC03 AUTOLOAD: waiting for player");
inline constexpr TCHAR RunningText[] = TEXT("HC03: stock enter/exit; NO AUTO DELETE");
inline constexpr TCHAR LoadFailureText[] = TEXT("HC03 CLASS LOAD FAILED; no spawn");
