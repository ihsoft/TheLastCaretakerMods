...
inline constexpr TCHAR Ready[] = TEXT("HC19: aim at cannon base; F8 prepares station, next F8 enters");
...
inline constexpr TCHAR AttachedYes[] = TEXT("Vehicle attached to cannon: YES");
inline constexpr TCHAR AttachedNo[] = TEXT("Vehicle attached to cannon: NO - STOP TEST");
inline constexpr TCHAR PlayerOnly[] = TEXT("Local player walking near a built cannon required");
...
inline constexpr TCHAR Ready[] = TEXT("HC24: aim at cannon base; F8 prepares, next F8 enters");
...
void ConfigureCombinedOperatorPoint(FGraph& G)
{
    ...
    // cannon at character height. Preserve the shell and native entry/exit.
