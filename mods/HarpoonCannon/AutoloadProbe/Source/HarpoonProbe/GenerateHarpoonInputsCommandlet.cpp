#include "GenerateHarpoonInputsCommandlet.h"
...
UGenerateHarpoonInputsCommandlet::UGenerateHarpoonInputsCommandlet()
{
    IsClient = false; IsServer = false; IsEditor = true; LogToConsole = true;
}

int32 UGenerateHarpoonInputsCommandlet::Main(const FString& Params)
{
    using namespace HarpoonInputNames;
