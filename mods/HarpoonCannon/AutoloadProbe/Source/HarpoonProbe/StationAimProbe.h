...
{
inline const FName Yaw(TEXT("CannonLocalAimYaw"));
inline const FName Pitch(TEXT("CannonLocalAimPitch"));
...
inline constexpr TCHAR YawLabel[] = TEXT("Cannon-local yaw (wrap +/-180): ");
inline constexpr TCHAR PitchLabel[] = TEXT("Cannon-local pitch (-50 to +10): ");
}
