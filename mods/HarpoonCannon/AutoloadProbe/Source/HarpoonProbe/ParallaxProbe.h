...
namespace EyeAim
{
inline const FName Yaw(TEXT("HarpoonEyeYaw"));
inline const FName Pitch(TEXT("HarpoonEyePitch"));
inline const FName Target(TEXT("HarpoonEyeTarget"));
...
void ConvergeEyeAim(FGraph& G)
{
    ...
    G.Link(G.ActorArray(Cannon, G.Read(N::OriginalPawn)), G.Pin(Trace, E::ActorsToIgnore));
