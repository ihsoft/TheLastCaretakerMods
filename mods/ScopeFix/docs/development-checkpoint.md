# Archived ScopeFix development report

Historical investigation record only. This is not the current mod description,
build instructions or a source of active dependencies. Current configuration
and reasoning live in aiming-configuration.md and the parent README.
