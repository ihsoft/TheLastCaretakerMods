...
inline constexpr TCHAR Ready[] = TEXT("HC18 Native HUD | Aim at railgun base and press F8");
...
inline constexpr TCHAR WrongTarget[] = TEXT("REFUSED: aim within3m at attached, BUILT Railgun base");
...
inline constexpr TCHAR Drift[] = TEXT("Current railgun-local drift (cm): ");
inline constexpr TCHAR Travel[] = TEXT("Anchor world travel (cm): ");
inline constexpr TCHAR Attached[] = TEXT("Character attached to railgun: YES");
inline constexpr TCHAR Detached[] = TEXT("Character attached to railgun: NO");
