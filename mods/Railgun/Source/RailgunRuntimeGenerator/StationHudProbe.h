...
inline const FName ScopeRows(TEXT("RailgunScopeRows"));
inline const FName ScopeFooter(TEXT("RailgunScopeFooter"));
...
inline constexpr TCHAR Lost[] = TEXT("Railgun: interface changed; released");
