...
constexpr TCHAR PawnAssetName[] = TEXT("BP_Railgun");
constexpr TCHAR HudPackageName[] = TEXT("/Game/Mods/Railgun/WBP_Railgun");
constexpr TCHAR HudAssetName[] = TEXT("WBP_Railgun");
...
constexpr TCHAR BaseMeshAssetName[] = TEXT("SM_RailgunBase");
constexpr TCHAR YawMeshPackageName[] = TEXT("/Game/Mods/Railgun/SM_RailgunYawAssembly");
constexpr TCHAR YawMeshAssetName[] = TEXT("SM_RailgunYawAssembly");
constexpr TCHAR PitchMeshPackageName[] = TEXT("/Game/Mods/Railgun/SM_RailgunPitchAssembly");
constexpr TCHAR PitchMeshAssetName[] = TEXT("SM_RailgunPitchAssembly");
constexpr TCHAR AmmoMeshPackageName[] = TEXT("/Game/Mods/Railgun/SM_RailgunAmmo");
constexpr TCHAR AmmoMeshAssetName[] = TEXT("SM_RailgunAmmo");
...
const FName GeneratorBlueprintName(TEXT("GenerateRailgunPawn"));
const FName GeneratorWidgetName(TEXT("GenerateRailgunHud"));
...
const FName BaseBodyName(TEXT("RailgunBaseBody"));
const FName TurretBodyName(TEXT("RailgunTurretBody"));
const FName BarrelBodyName(TEXT("RailgunBarrelBody"));
const FName LoadedConnectorName(TEXT("RailgunLoadedConnector"));
...
constexpr double RailgunIdleBufferWh = 1000.0 / 3600.0;
